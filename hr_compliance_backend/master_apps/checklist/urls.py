...
urlpatterns = [
    ...
    path("acts/", ActByStateAPIView.as_view(), name="act-list-by-state"),
    path("acts/create/", ActCreateAPIView.as_view(), name="act-create"),
    path("sections/", SectionByActAPIView.as_view(), name="section-list-by-act"),
    ...
    path("<int:pk>/toggle-status/", AuditChecklistToggleStatusAPIView.as_view(), name="checklist-toggle-status"),
]