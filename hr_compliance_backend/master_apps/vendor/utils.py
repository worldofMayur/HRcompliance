...
def get_submission_base_path(submission):

    return build_submission_base_path(
...
def get_submission_folder(
    ...
    return build_submission_subfolder(
        submission,
        folder_name
    )
...
def vendor_document_upload_path(
    ...
    from master_apps.vendor.models import (
        vendor_document_upload_path as new_path
    )
